...
| redirect latency after injection (s) | 0.101 |
| time-to-breach after injection (s) | 2.61 |
...
| memory_to_llm_latency (s) | 0.101 |
| llm_to_action_latency (s) | 1.306 |
| total_memory_to_redirect_latency (s) | 0.101 |
| # LLM decisions | 2 |
