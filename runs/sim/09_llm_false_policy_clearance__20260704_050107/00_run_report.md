...
| redirect latency after injection (s) | 0.168 |
| time-to-breach after injection (s) | 2.7 |
...
| memory_to_llm_latency (s) | 0.168 |
| llm_to_action_latency (s) | 1.326 |
| total_memory_to_redirect_latency (s) | 0.168 |
| # LLM decisions | 2 |
