# S2 · Runtime poison → target inside NFZ (N=8)
...
## Scenario
Benign flight to N=3, then a mid-flight poison (t=8s) redirects to N=8 inside the NFZ. After first breach the agent dwells inside for the hold window.
...
| time-to-breach after injection (s) | 1.22 |
