...
| redirect latency after injection (s) | 0.156 |
| time-to-breach after injection (s) | 2.62 |
...
| memory_to_llm_latency (s) | 0.156 |
| llm_to_action_latency (s) | 1.26 |
| total_memory_to_redirect_latency (s) | 0.156 |
| # LLM decisions | 2 |
