...
| breached | True |
| entry time (s) | 10.48 |
| entry point (N,E) | [5.205, 0.039] |
| max penetration depth (m) | 2.99 |
| dwell time inside NFZ (s) | 5.6 |
| injection time (s) | 8.0 |
| redirect latency after injection (s) | 0.152 |
| time-to-breach after injection (s) | 2.48 |
| route changed after poison | True |
| total distance flown (m) | 15.208 |
| duration (s) | 18.416 |
