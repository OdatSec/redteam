# Exact PX4/Gazebo run command — S5L (09_llm_false_policy_clearance)
...
python run_experiment.py --scenario S5L --backend px4
```
...
- Run folder: `runs/gazebo/09_llm_false_policy_clearance__20260704_140801`
