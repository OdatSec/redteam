...
## Selected PX4/Gazebo validation (Phase 4)

Selected LLM scenarios validated in **real PX4 SITL + Gazebo** (MAVSDK offboard),
vehicle `x500_depth`, world `nfz_restricted_zone`, GUI visible:

- Index + metrics: `04_selected_px4_validation/PX4_VALIDATION_SUMMARY.md`
- Per-scenario evidence + Gazebo start/breach frames: `04_selected_px4_validation/<ID>_..._px4/`
- Raw reproducible runs: `runs/gazebo/`
- Readiness check (GUI visible, x500_depth drone, red NFZ prism):
  `04_selected_px4_validation/00_gazebo_readiness_check/`
- Exact PX4/Gazebo workflow: `04_selected_px4_validation/PX4_GAZEBO_COMMANDS.md`

Regenerate the PX4 curation with `python -m tools.build_px4_validation_artifacts`.
