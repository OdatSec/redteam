...
For a live, smooth Gazebo demo (drones spawn, take off, then the swarm attack plays out through the NFZ), see [`SWARM_LIVE_GAZEBO_DEMO.md`](SWARM_LIVE_GAZEBO_DEMO.md):
...
This is **Gazebo visual playback from swarm telemetry, not PX4 multi-instance flight**.
